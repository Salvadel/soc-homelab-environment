...
3. [Ubuntu Server Setup](ubuntu-iem-server-setup.md) - Installs and configures the Ubuntu Server VM that later hosts the Wazuh SIEM stack, including static IP assignment. Covers the base operating system only.
