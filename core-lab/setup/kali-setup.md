...
Kali Linux was deployed using the prebuilt Kali Linux VMware virtual machine image rather than a manual ISO installation. The official Kali Linux VMware image can be downloaded from [The official Kali Linux website](https://www.kali.org/get-kali/#kali-virtual-machines).
